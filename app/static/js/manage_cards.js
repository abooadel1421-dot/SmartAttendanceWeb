// static/js/advanced_search.js - نظام البحث المتقدم المحدّث
    ...
    function applyFilters() {
        ...
        rows.forEach(row => {
            ...
            if (searchTerm) {
                ...
                const cardId = cardIdCell ? cardIdCell.textContent.toLowerCase() : '';
                const studentText = studentCell ? studentCell.textContent.toLowerCase() : '';
                
                isVisible = cardId.includes(searchTerm) || studentText.includes(searchTerm);
            }
